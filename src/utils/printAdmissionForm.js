...
<body>
  <article class="sheet">
    <header class="header">
      ...
      <p class="session">Session ${line(d.session || '2026-2027')}</p>
    </header>
    ...
    <div class="grid-2">
      ...
      <div class="row"><span class="label">Registration Fee :</span><span class="value">${line(d.registrationFee)}</span></div>
    </div>
