...
export default function BatchesPage() {
  ...
  const handleQuickCreateCourse = async () => {
    ...
    if (courseForm.type === 'University' && !courseForm.universityId) {
      setWizardError('Select a university for university courses')
      return null
    }
    setWizardBusy(true)
    try {
      const entry = await createCourse({
        ...
        universityId: courseForm.type === 'University' ? courseForm.universityId : '',
